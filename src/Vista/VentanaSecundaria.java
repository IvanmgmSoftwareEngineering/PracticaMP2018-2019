...
public class VentanaSecundaria extends JFrame implements Observer {
    ...
    public VentanaSecundaria(int idVentana) {
           initComponents();
...
//@Override
    public void notifyEvent(Modelo.GameEvent evento) {
    ...
    public void manejarEvento (Modelo.GameEvent evento) {
